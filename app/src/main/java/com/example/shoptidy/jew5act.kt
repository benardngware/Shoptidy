...
class jew5act : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_jew5)
        ...
        call.setOnClickListener {
            ...
            dialIntent.data = Uri.parse("tel:" + "0792109190")
            startActivity(dialIntent)
        }

        email.setOnClickListener {
            val emailIntent = Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "jufy@gmail.com", null))
