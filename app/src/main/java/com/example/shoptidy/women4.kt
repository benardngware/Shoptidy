...
class women4 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_women4)
        ...
        call.setOnClickListener {
            ...
            dialIntent.data = Uri.parse("tel:" + "0792000190")
            startActivity(dialIntent)
        }

        email.setOnClickListener {
            val emailIntent = Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "tyuiuyt@gmail.com", null))
