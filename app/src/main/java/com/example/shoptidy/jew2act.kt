...
class jew2act: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_jew2)
        ...
        call.setOnClickListener {
            ...
            dialIntent.data = Uri.parse("tel:" + "0792176190")
            startActivity(dialIntent)
        }

        email.setOnClickListener {
            val emailIntent = Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "juju@gmail.com", null))
