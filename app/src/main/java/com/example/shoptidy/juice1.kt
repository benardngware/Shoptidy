...
class juice1 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        call.setOnClickListener {
            ...
            dialIntent.data = Uri.parse("tel:" + "0788130190")
            startActivity(dialIntent)
        }

        email.setOnClickListener {
            val emailIntent = Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "lkjhg@gmail.com", null))
