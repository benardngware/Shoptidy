...
class juice5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_juice5)
        ...
        call.setOnClickListener {
            ...
            dialIntent.data = Uri.parse("tel:" + "0792130890")
            startActivity(dialIntent)
        }

        email.setOnClickListener {
            val emailIntent = Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "oiuytr@gmail.com", null))
